...
Provide information on where to report vulnerabilities, the expected frequency of updates on reported vulnerabilities, and what users can expect if a vulnerability is accepted or declined.
